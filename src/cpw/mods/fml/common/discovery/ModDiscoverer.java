...
public class ModDiscoverer
{
        ...
        else
        {
            for (int var4 = 0; var4 < var3.length; ++var4)
            {
                if (var3[var4].isFile())
                {
                    ...
                    {
                        FMLLog.fine("Skipping known library file %s", new Object[] {var3[var4].getAbsolutePath()});
                    }
                    else
                    {
    ...
    public List identifyMods()
    {
        ...
        while (var2.hasNext())
        {
            ...
            {
                FMLLog.log(Level.WARNING, var5, "Identified a problem with the mod candidate %s, ignoring this source", new Object[] {var3.getModContainer()});
            }
