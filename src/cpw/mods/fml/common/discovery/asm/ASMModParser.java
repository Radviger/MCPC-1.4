...
public class ASMModParser
{
    ...
    public void beginNewTypeName(String var1, int var2, String var3)
    {
        ...
        this.asmSuperType = Type.getObjectType(var3);
    }
    ...
    {
        return this.getASMSuperType().equals(Type.getType(BaseMod.class)) || var1.contains(this.getASMSuperType().getClassName());
    }
