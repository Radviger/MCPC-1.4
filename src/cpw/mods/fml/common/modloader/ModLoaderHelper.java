...
public class ModLoaderHelper
{
    ...
    {
        ModLoaderGuiHelper var2 = new ModLoaderGuiHelper(var0, var1);
        guiHelpers.put(Integer.valueOf(var1), var2);
        NetworkRegistry.instance().registerGuiHandler(var0, var2);
    }

    public static void openGui(int var0, EntityHuman var1, Container var2, int var3, int var4, int var5)
    {
        ModLoaderGuiHelper var6 = (ModLoaderGuiHelper)guiHelpers.get(Integer.valueOf(var0));
        var6.injectContainer(var2);
        var1.openGui(var6.getMod(), var0, var1.world, var3, var4, var5);
    }

    public static Object getClientSideGui(BaseModProxy var0, EntityHuman var1, int var2, int var3, int var4, int var5)
    {
        return sidedHelper != null ? sidedHelper.getClientGui(var0, var1, var2, var3, var4, var5) : null;
    }

    public static IDispenserHandler buildDispenseHelper(BaseModProxy var0)
    {
        return new ModLoaderDispenseHelper(var0);
    }
    ...
    public static void buildEntityTracker(BaseModProxy var0, Class var1, int var2, int var3, int var4, boolean var5)
    {
        ...
        var6.setCustomSpawning(new ModLoaderEntitySpawnCallback(var0, var6), EntityEnderDragon.class.isAssignableFrom(var1) || IAnimal.class.isAssignableFrom(var1));
    }
