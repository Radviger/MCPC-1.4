...
public class NetworkRegistry
{
    ...
    void playerLoggedIn(EntityPlayer var1, NetServerHandler var2, INetworkManager var3)
    {
    ...
    void connectionClosed(INetworkManager var1, EntityHuman var2)
    {
        Iterator var3 = this.connectionHandlers.iterator();
    ...
    void generateChannelRegistration(EntityHuman var1, NetHandler var2, INetworkManager var3)
    {
        Packet250CustomPayload var4 = new Packet250CustomPayload();
        var4.tag = "REGISTER";
        var4.data = this.getPacketRegistry(var1 instanceof EntityPlayer ? Side.SERVER : Side.CLIENT);
    ...
    {
        String var4 = var1.tag;
        Iterator var5 = Iterables.concat(this.universalPacketHandlers.get(var4), var3 instanceof EntityPlayer ? this.serverPacketHandlers.get(var4) : this.clientPacketHandlers.get(var4)).iterator();
    ...
    void openRemoteGui(ModContainer var1, EntityPlayer var2, int var3, World var4, int var5, int var6, int var7)
    {
        ...
        if (var8 != null && var9 != null)
        {
            ...
            if (var10 != null)
            {
                var2.nextContainerCounter();
                var2.k();
                int var11 = var2.containerCounter;
                ...
                var2.netServerHandler.sendPacket(var12);
                var2.activeContainer = var10;
                var2.activeContainer.windowId = var11;
                var2.activeContainer.addSlotListener(var2);
            }
        }
    }

    void openLocalGui(ModContainer var1, EntityHuman var2, int var3, World var4, int var5, int var6, int var7)
    {
    ...
    {
        NetworkModHandler var3 = FMLNetworkHandler.instance().findNetworkModHandler(Integer.valueOf(var2.a));

        if (var3 == null)
        {
            FMLLog.info("Received a tiny packet for network id %d that is not recognised here", new Object[] {Short.valueOf(var2.a)});
        }
        else
        {
