...
public class EntityRegistry
{
    ...
    private EntityRegistry()
    {
        ...
        Iterator var1 = EntityTypes.d.keySet().iterator();
    ...
    private void doModEntityRegistration(Class var1, String var2, int var3, Object var4, int var5, int var6, boolean var7)
    {
        ...
        try
        {
            ...
            if (!EntityTypes.c.containsKey(var1))
            {
                String var10 = String.format("%s.%s", new Object[] {var8.getModId(), var2});
                EntityTypes.c.put(var1, var10);
                EntityTypes.b.put(var10, var1);
        ...
        {
            FMLLog.log(Level.WARNING, var11, "The mod %s tried to register the entity (name,class) (%s,%s) one or both of which are already registered", new Object[] {var8.getModId(), var2, var1.getName()});
            return;
        }
    ...
    {
        if (EntityTypes.c.containsKey(var0))
        {
    ...
    public static void registerGlobalEntityID(Class var0, String var1, int var2, int var3, int var4)
    {
        ...
        else
        {
            ...
            EntityTypes.a(var0, var1, var2, var3, var4);
        }
    }

    public static void addSpawn(Class var0, int var1, int var2, int var3, EnumCreatureType var4, BiomeBase ... var5)
    {
        BiomeBase[] var6 = var5;
        ...
        while (var8 < var7)
        {
            BiomeBase var9 = var6[var8];
            List var10 = var9.getMobs(var4);
            ...
            while (true)
            {
                if (var11.hasNext())
                {
                    BiomeMeta var12 = (BiomeMeta)var11.next();
                ...
                var10.add(new BiomeMeta(var0, var1, var2, var3));
                ++var8;
                break;
            }
        }
    ...
    public static void addSpawn(String var0, int var1, int var2, int var3, EnumCreatureType var4, BiomeBase ... var5)
    {
        Class var6 = (Class)EntityTypes.b.get(var0);
    ...
    public static void removeSpawn(Class var0, EnumCreatureType var1, BiomeBase ... var2)
    {
        BiomeBase[] var3 = var2;
        ...
        {
            BiomeBase var6 = var3[var5];
            Iterator var7 = var6.getMobs(var1).iterator();

            while (var7.hasNext())
            {
                BiomeMeta var8 = (BiomeMeta)var7.next();
    ...
    public static void removeSpawn(String var0, EnumCreatureType var1, BiomeBase ... var2)
    {
        Class var3 = (Class)EntityTypes.b.get(var0);
    ...
    public boolean tryTrackingEntity(EntityTracker var1, Entity var2)
    {
        ...
        if (var3 != null)
        {
            var1.addEntity(var2, var3.getTrackingRange(), var3.getUpdateFrequency(), var3.sendsVelocityUpdates());
            return true;
        }
        else
        {
    ...
    {
        String var6 = (String)EntityTypes.c.get(var1);
