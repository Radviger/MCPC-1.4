...
public class VillagerRegistry
{
    ...
    public static Object getVillageComponent(WorldGenVillagePieceWeight var0, WorldGenVillageStartPiece var1, List var2, Random var3, int var4, int var5, int var6, int var7, int var8)
    {
        return ((VillagerRegistry$IVillageCreationHandler)instance().villageCreationHandlers.get(var0.a)).buildComponent(var0, var1, var2, var3, var4, var5, var6, var7, var8);
    }
    ...
    public static void addEmeraldBuyRecipe(EntityVillager var0, MerchantRecipeList var1, Random var2, Item var3, float var4, int var5, int var6)
    {
        if (var5 > 0 && var6 > 0)
        {
            EntityVillager.bP.put(Integer.valueOf(var3.id), new Tuple(Integer.valueOf(var5), Integer.valueOf(var6)));
        }

        EntityVillager.a(var1, var3.getMaxDurability(), var2, var4);
    }
    ...
    public static void addEmeraldSellRecipe(EntityVillager var0, MerchantRecipeList var1, Random var2, Item var3, float var4, int var5, int var6)
    {
        if (var5 > 0 && var6 > 0)
        {
            EntityVillager.bQ.put(Integer.valueOf(var3.id), new Tuple(Integer.valueOf(var5), Integer.valueOf(var6)));
        }

        EntityVillager.b(var1, var3.getMaxDurability(), var2, var4);
    }
