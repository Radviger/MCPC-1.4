...
public class FMLModContainer implements ModContainer
{
    ...
    public void bindMetadata(MetadataCollection var1)
    {
        ...
        else
        {
            ...
            FMLLog.finest("Parsed dependency info : %s %s %s", new Object[] {var2, var3, var4});
        }
        ...
        for (int var5 = 0; var5 < var4; ++var5)
        {
            ...
            for (int var9 = 0; var9 < var8; ++var9)
            {
                ...
                if (modTypeAnnotations.containsKey(var10.annotationType()))
                {
                    ...
                    {
                        FMLLog.severe("The mod %s appears to have an invalid method annotation %s. This annotation can only apply to methods with argument types %s -it will not be called", new Object[] {this.getModId(), var10.annotationType().getSimpleName(), Arrays.toString(var11)});
                    }
                }
            }
        }
        ...
        while (var6.hasNext())
        {
            ...
            if (var11 != null)
            {
                ...
                catch (Exception var15)
                {
                    ...
                    FMLLog.log(Level.WARNING, var15, "Attempting to load @%s in class %s for %s and failing", new Object[] {var5, var7.getClassName(), ((ModContainer)var11).getModId()});
                }
            }
            ...
            if (var9 != null)
            {
                ...
                if (!var12)
                {
                    ...
                    {
                        FMLLog.warning("Unable to inject @%s in non-static field %s.%s for %s as it is NOT the primary mod instance", new Object[] {var5, var7.getClassName(), var7.getObjectName(), ((ModContainer)var11).getModId()});
                        continue;
                    }
                }
    ...
    public void constructMod(FMLConstructionEvent var1)
    {
        try
        {
            ...
            ASMDataTable var4 = var1.getASMHarvestedData();
            var4.getAnnotationsFor(this);
            ...
            this.modInstance = var3.newInstance();
