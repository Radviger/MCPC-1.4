		...
		if (!ForgeHooks.onLivingUpdate(this))
		{
			...
			if (!this.world.isStatic)
			{
				for (int var1 = 0; var1 < 5; ++var1)
				{
					...
					if (!ItemStack.matches(var2, this.bU[var1]))
					{
						((WorldServer)this.world).getTracker().a(this, new Packet5EntityEquipment(this.id, var1, var2));
						this.bU[var1] = var2 == null ? null : var2.cloneItemStack();
					}
				}
			}
			...
			if (var5 > 0.0025000002F)
			{
				...
				var6 = (float) org.bukkit.craftbukkit.TrigMath.atan2(var3, var12) * 180.0F / (float)Math.PI  - 90.0F;
			}
