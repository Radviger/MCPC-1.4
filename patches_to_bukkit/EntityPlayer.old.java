  ...
  implements ICrafting
{
  ...
  private ItemStack[] ck = { null, null, null, null, null };
  ...
  public void a(boolean flag) {
    ...
    if ((getHealth() == this.cf) && (this.cg == this.foodData.a())) { if ((this.foodData.c() == 0.0F) == this.ch); } else {
      this.netServerHandler.sendPacket(new Packet8UpdateHealth(getHealth(), this.foodData.a(), this.foodData.c()));
      this.cf = getHealth();
  ...
  public EnumBedResult a(int i, int j, int k) { EnumBedResult enumbedresult = super.a(i, j, k);
